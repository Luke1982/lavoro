 ...
 *
 * Addresses end in .demo: that domain cannot exist, so no address here can ever
 * clash with a real customer's in the shared login lookup, and no mail can be
 * delivered to it even if something tried.
 */
return [
    'company' => [
     ...
     */
    'absence' => [
        ['email' => 'bas@lavoro.demo', 'label' => 'Vakantie', 'from_day' => 9, 'to_day' => 11],
        ['email' => 'yusuf@lavoro.demo', 'label' => 'Vrijdagmiddag vrij', 'weekly_on' => 4, 'from' => '12:00', 'to' => '17:00'],
    ],
];
