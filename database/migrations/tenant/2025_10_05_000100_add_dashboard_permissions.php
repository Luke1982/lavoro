    ...
    public function up(): void
    {
        ...
        $rows = [
            ...
            [
                ...
                'label' => 'Dashboard Open werkbonnen (niet verzonden) bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_open_serviceorders.sent_administration',
                'label' => 'Dashboard Open werkbonnen (verzonden naar administratie) bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_open_serviceorders.sent_customer',
                'label' => 'Dashboard Open werkbonnen (verzonden naar klant) bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_open_serviceorders.all',
                'label' => 'Dashboard Alle open werkbonnen bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_upcoming_servicejobs',
                'label' => 'Dashboard Aankomende periodieke controles bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_pending_tickets',
                'label' => 'Dashboard Openstaande tickets bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'name' => 'dashboard.see_map',
                'label' => 'Dashboard Kaart bekijken',
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ];
