...
/**
 * MaterialCategory index & show authorization.
 *
 ...
 */
class MaterialCategoryReadRequest extends FormRequest
{
    public function authorize(): bool
    {
        $user = Auth::user();
        return $user && ($user->isAdmin() || $user->hasPermission('materialcategory.read'));
    }
