...
/**
 * MaterialUsageUnit index & show authorization.
 *
 ...
 */
class MaterialUsageUnitReadRequest extends FormRequest
{
    public function authorize(): bool
    {
        $user = Auth::user();
        return $user && ($user->isAdmin() || $user->hasPermission('materialusageunit.read'));
    }
