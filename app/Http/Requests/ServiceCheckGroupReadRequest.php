...
/**
 * ServiceCheckGroup index & show authorization.
 *
 ...
 */
class ServiceCheckGroupReadRequest extends FormRequest
{
    public function authorize(): bool
    {
        $user = Auth::user();
        return $user && ($user->isAdmin() || $user->hasPermission('servicecheckgroup.read'));
    }
