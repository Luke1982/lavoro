...
class FreeformMaterialAdded extends BaseSignal
{
    ...
    {
        return 'serviceorder.freeform_material_added';
    }

    public static function label(): string
    {
        return 'Vrije materiaalregel toegevoegd';
    }
    ...
    {
        return 'Vrije materiaalregel toegevoegd: ' . $this->item_name . ' (aantal ' . $this->quantity . ')' . $this->taskSuffix();
    }
