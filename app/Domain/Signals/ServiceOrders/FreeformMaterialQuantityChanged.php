...
class FreeformMaterialQuantityChanged extends BaseSignal
{
    ...
    {
        return 'serviceorder.freeform_material_quantity_changed';
    }

    public static function label(): string
    {
        return 'Vrije materiaalregel aantal gewijzigd';
    }
    ...
    {
        return 'Vrije materiaalregel hoeveelheid aangepast: ' . $this->item_name . ' naar ' . $this->new_quantity . $this->taskSuffix();
    }
