...
class MaterialUnforeseenFlagChanged extends BaseSignal
{
    ...
    {
        return 'serviceorder.material_unforeseen_changed';
    }

    public static function label(): string
    {
        return 'Materiaal onvoorzien-markering gewijzigd';
    }
    ...
    {
        return 'Materiaal gemarkeerd als ' . ($this->unforeseen ? 'onvoorzien' : 'voorzien') . ': ' . $this->item_name . $this->taskSuffix();
    }
