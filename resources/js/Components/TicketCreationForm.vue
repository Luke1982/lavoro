<template>
    ...
    <div class="flex justify-end pt-2">
        ...
        <button @click.prevent="addTicket"
            class="inline-flex items-center px-4 py-2 bg-lavoro-blue border border-transparent rounded-md text-xs text-white tracking-widest hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150 cursor-pointer">
            Storing aanmaken
        </button>
    </div>
</template>
