<template>
    <div class="min-h-screen bg-gradient-to-br from-indigo-600 via-blue-500 to-emerald-500 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div class="relative bg-white/90 backdrop-blur-md rounded-2xl shadow-xl ring-1 ring-black/5 overflow-hidden">
                <div class="px-8 pt-8 pb-6 text-center">
                    <div class="mx-auto flex items-center justify-center gap-3">
                        <img class="h-10 w-auto rounded" src="https://susan.nu/onewebstatic/81ba2bac65.jpg" alt="Stedelijk water" />
                ...
                <form class="px-8 pb-8 space-y-5" @submit.prevent="login">
                    <div>
                        ...
                        <div class="relative">
                            <input v-model="loginForm.email" id="email" name="email" type="email" autocomplete="email" required
                    ...
                    <button type="submit" @click="login"
                        ...
                        <svg v-if="loginForm.processing" class="h-4 w-4 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4">
                ...
                <div class="absolute -inset-x-16 -bottom-16 h-32 bg-gradient-to-r from-indigo-400/20 via-blue-400/20 to-emerald-400/20 blur-2xl pointer-events-none"></div>
            </div>
        </div>
    </div>
