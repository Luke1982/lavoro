<template>
    ...
    <div class="mx-auto mt-10 max-w-md rounded-lg border border-slate-200 bg-white p-6">
        <h2 class="mb-4 mt-0 text-lg font-semibold">Inloggen</h2>
...
const submit = () => form.post('/beheer/login', { onFinish: () => form.reset('password') })
</script>
