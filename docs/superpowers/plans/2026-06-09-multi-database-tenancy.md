...
- [ ] **Step 1: Create the interface, the adapter and the flush**
...
- [ ] **Step 4: Replace `app/Providers/TenancyServiceProvider.php`**
...
- [ ] **Step 6: Make forgetting to tag a class fail a test, not production**
