...
- **Foto's**: afbeeldingen uploaden, een hoofdfoto aanwijzen, en op werkbonnen een apart blok voor interne foto's. De werkbon-PDF bundelt de (openbare) foto's van het werk. Wordt een werkbon verwijderd, dan gaan zijn foto's mee, ook de interne en die bij de keuringen.
